    ...
    <div className={`flex-1 flex flex-col overflow-y-auto px-3 sm:px-5 pt-3 sm:pt-4 pb-24 md:pb-4 space-y-4 text-left ${pulseMode ? 'bg-slate-50 dark:bg-slate-950' : 'bg-slate-50 dark:bg-slate-900'}`}>
      {pulseMode ? (
        <div className="flex items-center gap-2.5 px-0.5">
          <ClipboardList className="w-5 h-5 text-indigo-500/80 dark:text-indigo-400/80 shrink-0" />
          <div className="min-w-0">
            ...
            <p className="text-[10px] font-medium text-slate-400">Contributions · withdrawals · splits · recurring</p>
          </div>
        </div>
      ) : (
